...
namespace Cubed.Forms.Dialogs {
	partial class ProjectPickerDialog {
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProjectPickerDialog));
			this.nsUpButton = new NSIconicButton();
			this.clearButton = new NSButton();
			this.fileLabel = new NSTextBox();
			this.submitButton = new NSButton();
			this.nsSeperator1 = new NSSeperator();
			this.cancelButton = new NSButton();
			this.inspector = new NSDirectoryInspector();
		...
		private NSDirectoryInspector inspector;
		private NSTextBox fileLabel;
		private NSButton cancelButton;
		private NSSeperator nsSeperator1;
		private NSButton submitButton;
		private NSButton clearButton;
		private NSIconicButton nsUpButton;
	}
}