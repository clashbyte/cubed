...
namespace Cubed.Editing {
	...
	[InspectorIcon("Sound")]
	[InspectorName("Sound")]
	[InspectorDescription("SoundDesc")]
	[TargetPrefab(typeof(Prefabs.MapSound))]
	public class MapSound : EditableObject {
		...
		public AudioTrack Audio {
			get {
				return (Prefab as Prefabs.MapSound).Sound;
			}
			set {
				(Prefab as Prefabs.MapSound).Sound = value;
			}
		}
		...
		public override void Create(Scene scene) {
			if (Gizmo == null) {
				...
				if (gizmoIcon == null) {
					gizmoIcon = new Texture(Forms.Resources.InspectorIcons.Sound) {
			...
			//RebuildRing(((Cubed.Prefabs.MapSound)Prefab).Range);
			Prefab.Assign(scene);
		}
